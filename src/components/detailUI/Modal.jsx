...
import { stepperReducer, initialState } from '../../context/StepperReducer'
...
const Modal = ({office}) => {
    ...
    useEffect(() => {
        dispatch({ type: 'SET_OFFICE_ID', payload: 123 })
    }, [])
        ...
        if (state.checkoutStatus === 'success') {
            ...
            return (
                <div>
                    ...
                    <StepperControl steps={steps} currentStep={state.currentStep} dispatch={dispatch} />
                </div>
            );
        }
    };
